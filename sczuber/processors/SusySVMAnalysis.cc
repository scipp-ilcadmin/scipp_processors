...
void SusySVMAnalysis::init() { 
    ...
    _V_DED = new TH1F("V_DED","Detected Vector",400,0,100);
    _V_DAB = new TH1F("V_DAB","Detectable Vector",400,0,100);
    _V_TRU = new TH1F("V_TRU","True Vector",400,0,100);

    _S_DED = new TH1F("S_DED","Detected Scalar",400,0,100);
    _S_DAB = new TH1F("S_DAB","Detectable Scalar",400,0,100);
    _S_TRU = new TH1F("S_TRU","True Scalar",400,0,100);
 
  
    _M_DED = new TH1F("M_DED","Detected Mass",400,0,100);
    _M_DAB = new TH1F("M_DAB","Detectable Mass",400,0,100);
    _M_TRU = new TH1F("M_TRU","True Mass",400,0,100);
