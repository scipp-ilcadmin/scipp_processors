...
namespace scipp_ilc {
    namespace beamcal_recon_xy {
	    ...
	    int ID;
	    float energy;
	    float bgd_subtracted_energy;


            for (auto pixel : *pixels) {
                ID = pixel.first;
                energy = pixel.second;
                bgd_subtracted_energy = energy - (*average_map)[ID];
	    ...
	    float significance;
            for (auto bgd_subtracted_pixel : sorted_pixels) {
                ID = bgd_subtracted_pixel.first;
                bgd_subtracted_energy = bgd_subtracted_pixel.second;
                std_dev = (*std_dev_map)[ID];
