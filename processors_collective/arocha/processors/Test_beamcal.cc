...
Test_beamcal Test_beamcal;

static TFile* _rootfile;
static TProfile* _radeff;
static int _detected_num = 0;

Test_beamcal::Test_beamcal() : Processor("Test_beamcal") {
...
void Test_beamcal::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void Test_beamcal::processEvent( LCEvent* signal_event ) { 
...
void Test_beamcal::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void Test_beamcal::end(){ 
