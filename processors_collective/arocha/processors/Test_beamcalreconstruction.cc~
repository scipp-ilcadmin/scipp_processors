...
void Test_beamcalreconstruction::init() { 
    ...
    scipp_ilc::beamcal_recon_test::initialize_beamcal_reconstructor(_beamcal_geometry_file_name, _background_event_list, _num_bgd_events_to_read);
...
void Test_beamcalreconstruction::processEvent( LCEvent* signal_event ) { 
    ...
    scipp_ilc::beamcal_recon_test::beamcal_cluster* signal_cluster;
    signal_cluster = scipp_ilc::beamcal_recon_test::reconstruct_beamcal_event(signal_event);
