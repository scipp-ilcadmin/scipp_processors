...
BeamCalRecon BeamCalRecon;

static TFile* _rootfile;
static TProfile* _radeff;
static int _detected_num = 0;

BeamCalRecon::BeamCalRecon() : Processor("BeamCalRecon") {
...
void BeamCalRecon::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void BeamCalRecon::processEvent( LCEvent* signal_event ) { 
...
void BeamCalRecon::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void BeamCalRecon::end(){ 
