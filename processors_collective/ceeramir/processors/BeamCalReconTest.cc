...
BeamCalReconTest BeamCalReconTest;

static TFile* _rootfile;
static TProfile* _radeff;
static int _detected_num = 0;

BeamCalReconTest::BeamCalReconTest() : Processor("BeamCalReconTest") {
...
void BeamCalReconTest::processRunHeader( LCRunHeader* run) { 
//    _nRun++ ;
} 



void BeamCalReconTest::processEvent( LCEvent* signal_event ) { 
...
void BeamCalReconTest::check( LCEvent * evt ) { 
    // nothing to check here - could be used to fill checkplots in reconstruction processor
}



void BeamCalReconTest::end(){ 
